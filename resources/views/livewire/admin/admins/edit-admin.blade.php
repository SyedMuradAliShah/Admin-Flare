                ...
                <div class="profile-form">
                    <form wire:submit="saveImage">
                        <div class="text-center">
                            <x-admin.image-upload-view :model-var="$image" :current-image="$this->user->image" model-name="image" form-name="saveImage" />
                        </div>
                    </form>
                        ...
                        <div class="row row-cols-1 row-cols-lg-2">
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <x-admin.form.input-error :messages="$errors->get('form.password_confirmation')" class="mt-2" />
                                </div>
                            </div>
                        </div>
